...
public class Narrator {
    ...
    public static void startStory() {
        Fisherman urashima = new Fisherman("Urashima", 200, 60,60,200);
        ...
        while (endOfTheStory) {
            ...
            try {
                ...
                System.out.println("Рыбак тратит день на создание из подручных средств");
                urashima.setFishingrod("Удочка", Quality.NORMAL, new FishingLine(Quality.BAD));
